...
<template>
    <section>
        <div class="confirm-foot">
            ...
            <span :class="showbtn?'showbtn':''" class="confirm-next-btn" v-if="thisrouter=='date_trip'" @click="showbtn?islogin():''">{{shownext==true?$t('confirmFootComp.nextStep'):$t('NLoginShow')}}</span>
            ...
            <span class="contact-service" data-agl-cvt="1" @click="contactCustom()">
                <i></i>
        ...
        <div style="display: none" v-if="showbtn2==true">
            <form :action="apiPath.payment+'/payment/mobile/checkout'" method="post">
                ...
                <input type="text" name="success_url" value="" ref="success_url">
                <input type="text" name="failure_url" value="" ref="failure_url">
