<template>
    <div class="product-detail-page" ref="refProductDetailPage">
        <!-- 头部 -->
        <product-detail-header class="product-detail-header" v-if="product" :transparent="isTransparent" :title="product.name" fixed @callOnRight="onHeaderRight" ref="refProdctDetailHeader" />
...
:style="{'background': `url(${image}) no-repeat 0 0/100% 100%`}"></div> -->
            ...
            <div class="destination mt-24">
                ...
                <div class="item-wrap" @click="onServerNode">
                    <div class="item-list">
            ...
            <div class="footer-fixed">
                <div class="footer-tabbar">
                    <div class="operate">
                        <div class="btn-operate" v-for="item in operateTabbar" :key="item.name" @click="onOperate(item)">
            ...
            <!-- 服务说明 -->
            <van-actionsheet v-model="showServiceNode" :title="$t('productDetailPage.serviceDescription')" class="service-note">
            ...
            <!-- 优惠卷展开 -->
            <van-actionsheet v-model="showServiceCop" :title="$t('coupons')" class="service-note">
            ...
            <!-- 恢复预定通知 -->
            <van-actionsheet v-model="showSoldOut" title=" " class="sold-out">
