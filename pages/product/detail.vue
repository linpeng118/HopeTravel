...
import {getCookie, getLocalStore, setLocalStore, getSessionStore, setSessionStore} from '@/assets/js/utils'
...
export default {
  ...
  head() {
    return {
      ...
      meta: [{name: 'description', content: this.product.name || '', hid: 'description'}],
    }
  },
  components: {
    ProductDetailHeader,
