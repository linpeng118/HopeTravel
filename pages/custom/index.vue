...
<template>
  <div class="custom-page" ref="refCustomPage">
    <div class="custom-content">
      <!-- header -->
      <normal-header v-if="!isApp" :title="'私人定制'" :transparent="isTransparent" fixed/>
      <!-- banner -->
      <div class="banner">
        ...
        <div class="tag-list">
          <transp-tag v-for="tag in tagList" @callOnTag="onTag" :tag="tag" :key="tag.title"></transp-tag>
        </div>
        <div class="form-wrap">
          <div class="setover" ref="boxover">
            <div class="setover2" ref="conover">
              <p class="from-swiper" v-for="item in swiperuser" :key="item.name">
                <span
                  class="basecolor"
                >{{item.name}}&nbsp;&nbsp;{{item.phone.substr(0,3)}}****{{item.phone.substr(6,4)}}</span>
                <span>&nbsp;&nbsp;{{item.time}}&nbsp;&nbsp;</span>
      ...
      <div class="features">
        <div class="features-list">
          <div class="item" v-for="item in featureList" :key="item.title">
      ...
      <div class="season-recommend" ref="pingjia">
        ...
        <div class="season-wrap swiper-container" v-swiper:mySwiper="swiperOption">
          <div class="swiper-wrapper setsw">
            <div class="swiper-slide" v-for="(item,ind) in objpro.custom_view" :key="ind">
              <div class="season-item">
                <img :src="item.master_image_url" alt="img">
      ...
      <div class="season-recommend" style=" height: auto!important;" ref="luxian">
        ...
        <div
          class="season-item2"
          v-for="item in objpro.custom_spot"
          :key="item.id"
        ...
        >
          ...
          <p class="season-price basecolor">
            参考价格：
            <span class="pricebig">￥ {{item.price}}</span> 人/起
          </p>
        </div>
...
export default {
  ...
  mounted() {
    ...
    this.setInv = setInterval(function() {
      this_.setover();
    }, 1000);
    // 判断机型
    if (this.isApp) {
    ...
    setstyle() {
      ...
      if (document.all) {
        window.style =
          ".basecolor{color:" +
          maincolor +
          "!important;}.basebg{background-color:" +
          maincolor +
          "!important;}.baseboder{border:2px solid " +
          maincolor +
          "!important;}.mainbg{background: url('" +
          url +
          "') no-repeat 0 0px/100%!important;}";
        ...
        .form {
          ...
          .form-input {
            ...
            .left-icon {
              ...
              &.icon-phone {
                background: url("../../assets/imgs/newcustom/888@2x.png")
                  no-repeat;
                background-position: 0 25px;
        ...
        .form {
          ...
          .form-input {
            ...
            .left-icon {
              ...
              position: relative;
              &.icon-addr {
                background: url("../../assets/imgs/newcustom/910@2x.png")
                  no-repeat center center/40px 50px;
              }
              &.icon-phone {
                background: url("../../assets/imgs/newcustom/911@2x.png")
                  no-repeat center center/40px 44px;
              }
              &.icon-wx {
                background: url("../../assets/imgs/newcustom/863@2x.png")
                  no-repeat center center/45px 36px;
              }
              &::after {
                content: "";
                display: inline-block;
