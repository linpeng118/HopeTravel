  ...
  <div class="custom-page" ref="refCustomPage">
    <div class="custom-content">
          ...
          <div class="form">
            ...
            <div class="form-input">
              ...
              <van-cell-group class="transparent-input tours-input-no-bg">
                <van-field v-model="address" placeholder="请填写您想去的目的地或景点"/>
              </van-cell-group>
              <div class="right">*</div>
            </div>
            <!-- 手机号码 -->
            <div class="form-input phone">
              ...
              <van-cell-group class="transparent-input tours-input-no-bg">
                <van-field v-model="phone" placeholder="请填写您的电话号码"/>
              </van-cell-group>
              <div class="right">*</div>
            </div>
            <!-- 微信 -->
            <div class="form-input wechat">
              ...
              <van-cell-group class="transparent-input tours-input-no-bg">
                <van-field v-model="wechat" placeholder="请填写您的微信号码"/>
              </van-cell-group>
              <div class="right">*</div>
            </div>
            <!-- 定制按钮 -->
            <van-button
              class="btn-custom tours-button-no-bg"
              size="large"
              :loading="submiting"
              @click="onCustom"
            >开始定制</van-button>
      ...
      <div class="season-recommend">
        ...
        <div class="season-wrap wiper-container" v-swiper:mySwiper="swiperOption">
          <div class="swiper-wrapper">
            <div class="swiper-slide" v-for="item in seasonList" :key="item.title">
              <div class="season-item" @click="onSeasonRecommend(item)">
        ...
        <div class="btn-more" @click="toList">查看全部</div>
      </div>
      <!-- 承诺/服务 -->
      <div class="features">
      ...
      <div class="story-wrap" v-for="item in storyList" :key="item.title">
        ...
        <div class="show-banner">
          <img-item :proData="item.imgs" @callOnSlide="onSlide"/>
        </div>
      </div>
    </div>
    ...
    return {
      ...
      storyList: [
        ...
        },
        {
          ...
          pos: "2目的地：欧洲",
          desc:
            "2卸下工作的我，突然想去脚踏实地的感受一下旅行的意义。一般的旅行团都不会有这样的行程，旅行一次独属于我的私人旅行。",
          imgs: [
            {
              path: "custom/gushi2",
        ...
        },
        {
          ...
          pos: "3目的地：欧洲",
          desc:
            "3卸下工作的我，突然想去脚踏实地的感受一下旅行的意义。一般的旅行团都不会有这样的行程，旅行一次独属于我的私人旅行。",
          imgs: [
            {
              path: "custom/gushi3",
