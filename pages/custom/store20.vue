<template>
  <div>
    <div class="banner">
      ...
      <span class="title" style="line-height:.8rem;text-align:center;">网红巴厘岛 总价：9630 元/人</span>
    </div>
    <div class="ct">
      <h5 class="ct_title">为什么值得去</h5>
      <p class="paragraph">刷爆Instagram，刷爆小红书
        <br>你与网红只差一个“巴厘岛”的距离
        <br>是穿着比基尼站在森林瀑布下，若有所思；还是坐在秋千上，荡漾乌布的翠绿稻田
        <br>亦或是泡在泳池中，品尝精致的漂浮下午茶点
        <br>还是乘坐滑翔伞，俯瞰湛蓝天际线
        <br>都是一张张
        <br>美得不可万物的瞬间
        <br>
      ...
      <p class="paragraph">森林瀑布/网红秋千/漂浮下午茶/乌布皇宫/天空之门/莲花池台/水上皇宫/滑翔伞高空飞行体验</p>
      ...
      <div class="date">
        <div class="day1">
          ...
          <!-- <p class="date_paragraph">
                ...
                <div>
                    <img class="date-img" src="../../assets/imgs/custom/store20/d1_1.png" alt="">
                    <img class="date-img" src="../../assets/imgs/custom/store20/d1_2.png" alt="">
          </div>-->
        </div>
        <div class="day2">
        ...
        <div class="day3">
          ...
          <!-- <p class="date_paragraph">
                ...
                <div>
                    <img style="width:6.22rem;margin-top:.2rem;" src="../../assets/imgs/custom/store20/d1_3.png" alt="">
                    <img style="width:6.22rem;margin-top:.2rem;" src="../../assets/imgs/custom/store20/d1_4.png" alt="">
          </div>-->
        </div>
        <div class="day4">
        ...
        <div class="day5">
          ...
          <!-- <p class="date_paragraph">
                ...
                <div>
                    <img class="date-img" src="../../assets/imgs/custom/store20/d1_7.png" alt="">
                    <img class="date-img" src="../../assets/imgs/custom/store20/d1_8.png" alt="">
          </div>-->
        </div>
        <div class="day6">
...
.banner {
  background: url("../../assets/imgs/custom/store20/banner.png") no-repeat
