<template>
  <section>
    ...
    <div class="comment__create"
      ...
      @click.stop="linkToCreate(details)">追加评价</div>
  </section>
</template>
  ...
  export default {
    ...
    data() {
      return {
        details: {
          ...
          child_count: 0,
          product_name:
            '(6天) 美东经济6日游：世界的中心纽约，美国首都华盛顿，更有雄伟壮观的尼亚加拉大瀑布！【纽约、费城、华盛顿特区、康宁、尼亚加拉大瀑布、波士顿、漩涡公园】',
          product_id: 63,
    ...
    methods: {
      ...
      subData() {
        ...
        this.$refs.success_url.value =
          '//' + window.location.host + '/personal/order_des?order_id=' + this.details.order_id
