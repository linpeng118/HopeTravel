        ...
        <div class="header">
            ...
            <div class="con">
                ...
                <div class="text">
                    ...
                    <nuxt-link tag="span" v-else class="span1" to="/login">{{$t('login')}}/{{$t('regist')}}</nuxt-link>
                    <nuxt-link tag="span" v-if="JSON.stringify(profile) === '{}'" class="span2" to="/order/search">手机号查单</nuxt-link>

                </div>
                <div class="icon-kefu" data-agl-cvt="1" @click="contactCustom">
                    <img src="../../assets/imgs/personal/index/kefu.png" alt="">
                </div>
            </div>
            <div class="elsecon" v-if="!isLogin">
                <div>
                    <nuxt-link to="/login">查看{{$t('personalPage.riceGrain')}}</nuxt-link>
                </div>
                <div>
                    <nuxt-link to="/login">查看{{$t('coupons')}}</nuxt-link>
                </div>
            </div>
        ...
        <div class="body">
            ...
            <div class="main-menu">
                <div class="menu-item" v-for="(item, index) in statusList" :key="index" @click="allOrders(item)">
                    <dl>
                        <dt>
                            <img v-if="item.status === 'unpaid'" src="../../assets/imgs/personal/index/ic_daichuxing@2x.png" alt>
                            <img v-else-if="item.status === 'wait'" src="../../assets/imgs/personal/index/ic_weifukuan@2x.png" alt>
                            <img v-else-if="item.status === 'comment'" src="../../assets/imgs/personal/index/ic_daipinglun@2x.png" alt>
                            <img v-else src="../../assets/imgs/personal/index/ic_daichuxing@2x.png" alt>
                        </dt>
                        <dd>{{item.title}}</dd>
                    </dl>
                </div>
