<template>
  <div class="sssssss">
    <lay-header searchKeyWords="城市/景点/产品/关键字"
                :isSearch="isSearch"
    ...
    <div class="search-wrap"
        ...
        <div class="search-items">
          <div class="main-item">
            <div class="item-info"
              ...
              <i class="van-icon van-icon-cross"
                 @click="deleteHistory(index)"></i>
            </div>
          </div>
        </div>
      </div>
      <div :class="historyList.length ? 'search-content-w' : ''">
        ...
        <recommend :data="recommendObj"
                   ...
                   v-if="activeKey === 0"
                   @selectDetail="selectDetail"></recommend>
        <!--其他地区的推荐-->
    ...
    <div class="search-result"
      ...
      <template v-if="searchResultList.searchCategory.length">
        ...
        <square-tag :lists="searchResultList.searchCategory"
                    @selectProductList="selectProductList"></square-tag>
      </template>
      <search-result :lists="searchResultList.searchProduct"
                     @selectItem="selectProductInfo"></search-result>
    </div>
    <loading-tr v-if="searchLoading"
                :loading="loading"></loading-tr>
